...
void DMA1_Stream3_IRQHandler(void)
{
  ...
  HAL_DMA_IRQHandler(&hdma_tim1_com);
...
void TIM3_IRQHandler(void)
{
  ...
  if (Snake_IsActive())
      ...
      IS_RenderNext();
  else if (AnimV3_IsActive())
      AnimV3_RenderNext();
  else if (AnimV2_IsActive())
      AnimV2_RenderNext();
  else if (AnimPlayer_IsActive())
      AnimPlayer_RenderNext();
  else if (SlicePlayer_IsActive())
      SlicePlayer_RenderNext();
  else
      VolumeToWS2812_RenderNext();
  s_phase_count++;
