...
DMA_HandleTypeDef hdma_tim1_com;
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    /* TIM1_COM Init */
    hdma_tim1_com.Instance = DMA1_Stream3;
    hdma_tim1_com.Init.Request = DMA_REQUEST_TIM1_COM;
    hdma_tim1_com.Init.Direction = DMA_PERIPH_TO_MEMORY;
    hdma_tim1_com.Init.PeriphInc = DMA_PINC_DISABLE;
    hdma_tim1_com.Init.MemInc = DMA_MINC_ENABLE;
    hdma_tim1_com.Init.PeriphDataAlignment = DMA_PDATAALIGN_HALFWORD;
    hdma_tim1_com.Init.MemDataAlignment = DMA_MDATAALIGN_HALFWORD;
    hdma_tim1_com.Init.Mode = DMA_NORMAL;
    hdma_tim1_com.Init.Priority = DMA_PRIORITY_LOW;
    ...
    __HAL_LINKDMA(tim_baseHandle,hdma[TIM_DMA_ID_COMMUTATION],hdma_tim1_com);
  ...
  /* USER CODE END TIM2_MspInit 0 */
    ...
    /* TIM2 DMA Init */
    /* TIM2_UP Init */
    hdma_tim2_up.Instance = DMA1_Stream4;
  ...
  /* USER CODE END TIM3_MspInit 0 */
    ...
    /* TIM3 interrupt Init */
    HAL_NVIC_SetPriority(TIM3_IRQn, 2, 0);  /* 低于 SDMMC(1), 高于 UART(3) */
